...
import static sat.env.Bool.FALSE;
import static sat.env.Bool.TRUE;
...
public class SAT2Test {
    ...
    public static void main(String[] args) throws IOException {
        String name = args[0];
        File file = new File("..\\..\\2D\\2d-demo\\" + name);
        ...
        if (e == null){
            ...
            for (Clause c: formula.getClauses()){
                for (Literal l: c) {
                    if (e.get(l.getVariable()) == TRUE){
                        System.out.print("1 ");
                    }
                    else if (e.get(l.getVariable()) == FALSE){
                        System.out.print("0 ");
                    }
                }
            }
